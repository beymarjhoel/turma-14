			...
			do {
				switch(escolha) {
					case '1':
						...
						cpf = scan.next();
						cadastroCliente(nome, genero, anoNascimento, cpf);
						...
						quantidade = scan.nextInt();
							for (Produto lista : estoque) {
								if (codigoProdutoEscolhido.contains(lista.getCodigoProduto())) {
									...
									carrinho.add(new Produto(lista.getNomeProduto(), lista.getNomeProduto(), lista.getPrecoUnitario(), quantidade));
								} 
							}	
					break;
